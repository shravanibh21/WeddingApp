...
describe('guest', function(){
    ...
    it('parseGuest', function(){
        ...
        assert.deepEqual(parseGuest({name: 2, host: "Host A", isFamily: false, hasPlusOne: 0, 
        ...
        assert.deepEqual (parseGuest({name: "name", host: "Host A", isFamily: "str", hasPlusOne: 0, 
            diet: "diet", plusOneName: "someone", plusOneDiet: "something"}), undefined); //not valid isFamily

        assert.deepEqual (parseGuest({name: "name", host: "Host A", isFamily: false, hasPlusOne: 3, 
            diet: "diet", plusOneName: "someone", plusOneDiet: "something"}), undefined); //not valid hasPlustOne
        
        assert.deepEqual (parseGuest({name: "name", host: "Host A", isFamily: false, hasPlusOne: 0, 
        ...
        assert.deepEqual (parseGuest({name: "name", host: "Host A", isFamily: false, hasPlusOne: 0, 
            ...
            {name: "name", host: "Host A", isFamily: false, hasPlusOne: 0, 
